-- <leader><Ctrl-n>     Toggle File Navigator
...
vim.api.nvim_set_keymap('n', '<leader><C-n>', ':Neotree toggle=true<CR>', opts)
vim.api.nvim_set_keymap("n", "<leader><C-q>", ":TagbarToggle<CR>", opts)
vim.api.nvim_set_keymap("n", "<leader><C-t>", ":tabnew<CR>", opts)
-- vim.keymap.set("n", "<leader><C-f>", ":Neotree reveal<CR>", opts)

-- Folding with treesitter, by default open folds
